"""
Modified from https://github.com/openai/supervised-reptile

Supervised Reptile learning and evaluation on binary 
...
class Reptile:
    ...
    def train_step(self,
        ...
        for _ in range(meta_batch_size):
            mini_dataset = _sample_mini_dataset(dataset, num_shots)
    ...
    def evaluate(self,
        ...
        Args:
          ...
          num_shots: number of examples per data class.
          inner_batch_size: batch size for every inner-loop
            training iteration, currently not used.
          inner_iters: number of inner-loop iterations.
          replacement: sample with replacement.
...
def _mini_batches(samples, batch_size, num_batches, replacement):
    """Currently always return all the samples as a single batch.
    """
    # Ignore  batch size and replacement since we use all the
